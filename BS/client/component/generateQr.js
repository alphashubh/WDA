            ...
            <div>
                <center>
                    ...
                    <div className="img-fluid img-thumbnail">
                        <QrCode />
                        <a href="http://localhost:3000/downloadQR" download target="_blank"><button className="btn btn-primary">Download <span class="glyphicon glyphicon-download-alt" aria-hidden="true"></span></button></a>
